...
function TeoremaPitagoras(request) {
    ...
    this.calcularCatetoA = function(){
        ...
        respuestaDescritiva.push( "c =" + Math.sqrt(Math.pow(this.hipotenusa, 2) - Math.pow(this.catetoB, 2)));

        return {resultado:catetoA.toFixed(2), historial: respuestaDescritiva};
    };
